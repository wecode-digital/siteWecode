        ...
        <div className={"footer-container-desk"}>
                ...
                <ul className={"form-column"}>
                  ...
                  <li>
                    <p
                      ...
                      onClick={() => {
                        handleScrollToSection(`.${homeStyles.ourClients}`);
                      }}
                    >
                      Nossos clientes
                    </p>
                  ...
                  <li>
                    <p
                      ...
                      onClick={() => {
                        handleScrollToSection(`.${homeStyles.aboutUs}`);
                      }}
                    >
                  ...
                  <li>
                    <p
                      ...
                      onClick={() => {
                        handleScrollToSection(`.${homeStyles.howGenerateValue}`);
                      }}
                    >
                      Como geramos valor
                    </p>
                  ...
                  <li>
                    <p
                      ...
                      onClick={() => {
                        handleScrollToSection(`.${homeStyles.methodology}`);
                      }}
                    >
                      O que fazemos
                    </p>
                    ...
                    <li>
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <g clipPath="url(#clip0_410_11806)">
                            <path
          ...
          <div className={"footer-final"}>
            <div className={"footer-final-container"}>
              <Image src={wecodeImg} rel="noreferrer" alt="wecode-imagem" />
              <div>
